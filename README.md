...
- A bilingual mobile experience with English and Arabic RTL support.
- Learning and discovery flows that connect content to action.
- Mentor profiles, availability, bookings, session preparation, and recaps.
- Communities, events, and an opportunity directory with trust and moderation workflows.
- A role-aware operator console for curation, review, moderation, and audit.

## Engineering focus

- Expo and React Native for iOS, Android, and web preview.
- TypeScript across the product and a shared generated database contract.
- Next.js for the operator console.
- Supabase Postgres, Auth, Row Level Security, Storage, and Edge Functions.
- Feature-scoped APIs, server-authoritative authorization, bilingual UI checks, and reproducible local verification.
